    ...
    <div className="row mt-5 skills">
      <div className={`${center} col-12`}>
        {firstColumnSkills.map((skill) => (
          <div key={skill.id} className="skill-item" nmae={skill.name}>
            <img src={skill.img} alt={skill.name} className="skill-image" />
            <p className="text-center skill-p">{skill.name}</p>
          </div>
        ))}
      </div>
      <div className={`${center} col-12`}>
        {secondColumnSkills.map((skill) => (
          <div key={skill.id} className="skill-item" nmae={skill.name}>
            <img src={skill.img} alt={skill.name} className="item-center skill-image" />
            <p className="text-center skill-p">{skill.name}</p>
          </div>
        ))}
      </div>
